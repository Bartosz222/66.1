...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(349, 331);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(248, 82);
			...
			this->textBox1->Location = System::Drawing::Point(187, 107);
			this->textBox1->Multiline = true;
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(603, 150);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		Trojki* c = new Trojki(msclr::interop::marshal_as<std::string>(file));
		c->wczytaj();
